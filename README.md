# Wisetime Front-End: Como rodar o projeto em ambiente local
...
```
git clone https://github.com/eduardogneto/wisetime-front.git
```
...
Acesse o projeto Wisetime no navegador em:
